...
AND atm_location = 'Leggett Street' AND transaction_type = 'withdraw')) AND name IN (SELECT name FROM people
WHERE license_plate IN (SELECT license_plate FROM bakery_security_logs WHERE year = 2023 AND month = 7
AND day = 28 AND hour = 10 AND minute > 15 AND minute < 25 AND activity = 'exit')) AND name IN (SELECT name FROM people, passengers
...
| 233 | (367) 555-5533 | (375) 555-8161 | 2023 | 7     | 28  | 45       | <- less than 1 minute, earlist call
...
| 395 | (367) 555-5533 | (455) 555-5315 | 2023 | 7     | 30  | 31       | <- less than 1 minute
| 418 | (367) 555-5533 | (841) 555-3728 | 2023 | 7     | 30  | 511      |
| 488 | (367) 555-5533 | (696) 555-9195 | 2023 | 7     | 31  | 261      |
+-----+----------------+----------------+------+-------+-----+----------+ */
SELECT * FROM phone_calls WHERE year = 2023 AND month = 7 AND day = 28 AND receiver
